...
class AirportListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Airport
        fields = ("id", "name", "closest_big_cite", "country",)
...
class FlightListSerializer(FlightSerializer):
    ...
    class Meta:
        model = Flight
        fields = ("id","departure_time", "arrival_time", "airplane_name", "airplane_capacity", "route", "tickets_available")
...
class FlightDetailSerializer(FlightSerializer):
    ...
    airplane_type = serializers.CharField(source="airplane.airplane_type.name", read_only=True)
    ...
    class Meta:
        model = Flight
        fields = ("id","departure_time", "arrival_time","distance", "airplane", "airplane_type", "crew", "route_source", "route_destination", "taken_places")
